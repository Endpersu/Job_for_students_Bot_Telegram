...
async def make_guess(message: types.Message):
    ...
    if chat_id not in group_games:
        await message.answer("Сначала начните игру с помощью /start_game")
        return
    ...
    try:
        ...
        await message.answer(f"Используйте команду так: /guess <число>")
    ...
    if guess < secret_number:
        ...
        await message.answer(f"Поздравляю! Вы угадали число {secret_number}")
